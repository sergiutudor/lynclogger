...
namespace LyncLogger
{
    public partial class MainView : Form
    {
        ...
        const string searchGuideline = "Search";
        ...
        public MainView(LyncConnection Connection)
        {
            ...
            searchBox.Text = searchGuideline;
            ...
            if (currentConfig.getIsDebugMode())
            {
                Text += " DEBUG";
            }
        ...
        private void showSearchControls(int matchesCount)
        {
            resultCount.Text = matchesCount.ToString() + " matches found";
            resultCount.Visible = true;
            searchNext.Visible = true;
            searchPrev.Visible = true;
        }
        ...
        {
            if (searchBox.Text == searchGuideline)
            {
                searchBox.Text = "";
            }
        ...
        private void onSearch(Object sender, KeyEventArgs args)
        {
            ...
            try
            {
                showSearchControls(renderer.getMatchesCount());
            }
            catch (Exception)
            {
                hideSearchControls();
